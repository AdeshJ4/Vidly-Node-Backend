 ...
 * -> so you don't have to ask its name and all other details and write again because user is already registered itself if not then it have to. 
...
const rentalSchema = new mongoose.Schema({
  ...
  movie: {
    ...
    required: [true, "Movie details are important"]
  },
  dateOut: {
    type: Date,
    required: true,
